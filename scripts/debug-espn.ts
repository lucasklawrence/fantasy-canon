...
async function main(): Promise<void> {
  ...
  if (!opts) {
    console.log("Usage:");
    console.log("  pnpm debug:espn -- --league <id> --season <year> --view <mTeam|mTransactions|...>");
    console.log("  pnpm debug:espn -- --league <id> --season <year> --view mTransactions2 --limit 50 --offset 0");
...
async function fetchLegacy(opts: CliOptions): Promise<void> {
  ...
  const url = new URL(
    `https://fantasy.espn.com/apis/v3/games/ffl/leagueHistory/${leagueId}`
  );
