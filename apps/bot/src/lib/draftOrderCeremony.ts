...
export interface RevealStage {
  ...
  /**
   * Release a refused "start a lottery" press (#253) with a reason the idle screens show once.
   * Optional (test doubles, older apis) and best-effort — a refusal stands either way.
   */
