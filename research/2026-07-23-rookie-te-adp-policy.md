...
- **True 2026 rookie TEs are not a redraft consideration** — the
  [rookies & breakouts report](2026-07-19-rookies-breakouts.md) found no 2026 rookie TE priced as a
  startable asset (Kenyon Sadiq, NYJ, ~R12+ is best-ball-only). The market already prices them out,
  so there is nothing to fade there; "trust the market" = don't draft them.
...
- [`2026-07-12-2026-midround-tiers-rookies-fades.md`](2026-07-12-2026-midround-tiers-rookies-fades.md) — Loveland fade, Fannin board row
- [`2026-07-19-rookies-breakouts.md`](2026-07-19-rookies-breakouts.md) — rookie TE pricing (Sadiq best-ball-only)
